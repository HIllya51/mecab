...
XS(_wrap_delete_Path) {
  {
    ...
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_mecab_path_t, SWIG_POINTER_DISOWN |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_delete_Node) {
  {
    ...
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_mecab_node_t, SWIG_POINTER_DISOWN |  0 );
    if (!SWIG_IsOK(res1)) {
...
{"MeCabc::delete_Path", _wrap_delete_Path},
...
{"MeCabc::delete_Node", _wrap_delete_Node},
